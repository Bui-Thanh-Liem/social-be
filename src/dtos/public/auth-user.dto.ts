...
export const ForgotPasswordUserDtoSchema = z.object({
  email: z.string().email('Email không hợp lệ').trim()
})

export const ResetPasswordUserDtoSchema = z
  .object({
    password: z
      .string()
      .regex(CONSTANT_REGEX.STRONG_PASSWORD, {
...
export const UpdateMeUserDtoSchema = z.object({
...
export type ForgotPasswordUserDto = z.infer<typeof ForgotPasswordUserDtoSchema>
export type ResetPasswordUserDto = z.infer<typeof ResetPasswordUserDtoSchema>
export type UpdateMeUserDto = z.infer<typeof UpdateMeUserDtoSchema>
