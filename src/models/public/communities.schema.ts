...
import { EActivityType, EInvitationStatus, EMembershipType, EVisibilityType } from '~/enums/public/communities.enum'
import {
  IActionActivity,
  ICommunity,
  ICommunityActivity,
  ...
  ICommunityMentor,
  ICommunityPin
} from '~/interfaces/public/communities.interface'
import { CONSTANT_INVITE_EXPIRES } from '~/constants/communities.constant'
...
export let CommunitiesCollection: Collection<CommunitiesSchema>
