...
import { CreateSearchHistoryDto } from '~/shared/dtos/public/search-history.dto'
...
import { SearchHistoryCollection, SearchHistorySchema } from '~/schemas/public/search-history.schema'
