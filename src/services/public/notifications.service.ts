...
import { CreateNotiDto } from '~/shared/dtos/public/notifications.dto'
...
import { COLLECTION_COMMUNITIES_NAME } from '~/schemas/public/community.schema'
import { COLLECTION_USERS_NAME } from '~/schemas/public/user.schema'
import { publishNotification } from '~/helpers/pubsub/publisher'
...
import { NotificationsCollection, NotificationsSchema } from '../../schemas/public/notification.schema'
import { COLLECTION_TWEETS_NAME } from '../../schemas/public/tweet.schema'
