...
import { CreateNotiCommentDto } from '~/dtos/public/notifications.dto'
import { CreateTweetDto, ResCountViewLinkBookmarkInWeek } from '~/dtos/public/tweets.dto'
...
import { EMembershipType, EVisibilityType } from '../../enums/public/communities.enum'
import { ENotificationType } from '../../enums/public/notifications.enum'
import { EFeedType, EFeedTypeItem, ETweetAudience, ETweetStatus, ETweetType } from '../../enums/public/tweets.enum'
import { ESourceViolation } from '../../enums/public/user-violations.enum'
import { COLLECTION_LIKES_NAME, LikesCollection } from '../../models/public/likes.schema'
...
class TweetsService {
  ...
  async getTweetBookmarked({
    ...
    const bookmarked_tweet_ids = await BookmarksCollection.distinct('tweet_id', {
      user_id: new ObjectId(user_active_id)
    })
