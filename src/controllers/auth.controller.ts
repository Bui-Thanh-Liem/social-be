...
class AuthController {
  ...
  async logout(req: Request, res: Response) {
    ...
    const result = await authService.logout({ refresh_token, user_id })
  ...
  async resetPassword(req: Request, res: Response) {
    const result = await authService.resetPassword(req?.user?._id as ObjectId, req.body)
  ...
  async updateMeUser(req: Request, res: Response) {
    const { user_id } = req.decoded_authorization as IJwtPayload
    const result = await authService.updateMeUser(user_id, req.body)
