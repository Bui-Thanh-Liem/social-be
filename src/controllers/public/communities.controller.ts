...
class CommunityController {
  ...
  async changeInfo(req: Request, res: Response) {
    ...
    const result = await communitiesService.changeInfo({ community_id, payload, user_id: user_id! })
  ...
  async join(req: Request, res: Response) {
    ...
    const { user } = req
    const result = await communitiesService.join({ user_id: user_id!, community_id, user })
  ...
  async leave(req: Request, res: Response) {
    ...
    const { community_id } = req.params as JoinLeaveCommunityDto
    const { user } = req
    const result = await communitiesService.leave({ user_id: user_id!, community_id, user })
  ...
  async promoteMentor(req: Request, res: Response) {
    ...
    const result = await communitiesService.promoteMentor({ actor_id: actor_id!, target_id, community_id })
  ...
  async demoteMentor(req: Request, res: Response) {
    ...
    const result = await communitiesService.demoteMentor({ actor_id: actor_id!, target_id, community_id })
  ...
  async update(req: Request, res: Response) {
    ...
    const result = await communitiesService.update({ payload, user_id: user_id! })
  ...
  async getMultiOwner(req: Request, res: Response) {
    const { user_id } = req.decoded_authorization as IJwtPayload
    const result = await communitiesService.getMultiOwner({ user_id: user_id!, query: req.query })
  ...
  async getMultiJoined(req: Request, res: Response) {
    const { user_id } = req.decoded_authorization as IJwtPayload
    const result = await communitiesService.getMultiJoined({ user_id: user_id!, query: req.query })
  ...
  async getMultiMMById(req: Request, res: Response) {
    ...
    const { user_id } = req.decoded_authorization as IJwtPayload
    const result = await communitiesService.getMultiMMById({ community_id, user_id: user_id!, queries })
  ...
  async deleteInvitation(req: Request, res: Response) {
    ...
    const { user_id } = req.decoded_authorization as IJwtPayload
    const result = await communityInvitationService.delete({ user_id: user_id!, payload })
  ...
  async inviteMembers(req: Request, res: Response) {
    const { user_id } = req.decoded_authorization as IJwtPayload
    const { user } = req
    const result = await communitiesService.inviteMembers({ user_id: user_id!, payload: req.body, user: user! })
